        ...
        rightSlot={
          <>
            <button
              ...
              className="h-8 flex items-center gap-1.5 border border-surface-border hover:border-surface-border-hover text-text-secondary hover:text-text-primary text-[14.5px] px-3 rounded-[8px] transition-colors active:scale-[0.96] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/50 focus-visible:ring-offset-1 focus-visible:ring-offset-surface-dark"
            >
              Копировать
            </button>
            <button
