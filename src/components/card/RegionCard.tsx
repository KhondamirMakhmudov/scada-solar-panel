...
interface StateAndMetricProps {
  value: string | number;
  label: string;
}

const StatItem = ({ value, label }: StateAndMetricProps) => (
...
const Metric = ({ value, label }: StateAndMetricProps) => (
  <div className="text-center">
...
interface InverterCardProps {
  inverter: {
    ...
    totalGeneration: string | number;
    efficiency: string | number;
  };
}

const InverterCard = ({ inverter }: InverterCardProps) => {
