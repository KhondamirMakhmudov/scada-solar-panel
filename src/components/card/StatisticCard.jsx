...
const StatCard = ({
  ...
  return (
    <motion.div
      ...
      className="group relative bg-surface-dark border border-surface-dark rounded-[2px] p-6 hover:border-primary/50 transition-all duration-300"
    >
      ...
      <div className="relative flex justify-between">
        <div>
          <div className="flex items-center justify-between mb-4">
            <div
              className={`w-12 h-12 rounded-[2px] bg-${iconColor}/10 border border-${iconColor}/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
            >
              <span
